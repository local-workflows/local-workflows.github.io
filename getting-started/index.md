...
2. **[Agent SDKs](https://local-workflows.github.io/getting-started/agent-sdks.md)** — GHCP,
   ...
   session is given. `claude` is the other SDK provider; seven more
   come in over ACP (item 10). Everything that is not an AI task works
   without any of them.
...
4. **[Workflows](https://local-workflows.github.io/getting-started/workflows.md)** — one
   pipeline: stages, tasks in order, an AI draft, a human gate, and
   one task per item with `foreach:`.
...
7. **[Plugins](https://local-workflows.github.io/getting-started/plugins.md)** — the last,
   smallest thing that executes. The eight that ship, and writing your
