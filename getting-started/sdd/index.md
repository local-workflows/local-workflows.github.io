...
phase on the rail. See [Custom styles](https://local-workflows.github.io/getting-started/sdd/custom-style.md#2-the-input-gate-is-not-yours-to-place-the-output-gate-is-yours-to-choose).
...
gets no phase on the rail for it — the work starts from the Tasks page
...
With several chats open, the execution phase's **Logs** and **AI
Session** tabs show one at a time — a picker names each lane by its wave
or task, and **notes** is the panel's own account of what started and
what stopped short. The newest lane is shown until you pick another.
